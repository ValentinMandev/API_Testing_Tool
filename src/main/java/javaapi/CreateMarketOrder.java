...
public class CreateMarketOrder {
    ...
    public CreateMarketOrder(String[] aArgs) throws FileNotFoundException {
        ...
        outputFile = "output/javaapi/execution_report_market_order_" + aArgs[8] + ".txt";
    ...
    private boolean doResult(final MessageTestHandler aMessageTestHandler) {
        ...
        if (reports.size() == 1) {
            String[] executionReport = reports.get(0).split("\\{")[1].split(", ");
            result.add(executionReport[1]);
            result.add(executionReport[2]);
            result.add(executionReport[5]);
            result.add(executionReport[8]);
            result.add(executionReport[9]);
            result.add(executionReport[11]);
